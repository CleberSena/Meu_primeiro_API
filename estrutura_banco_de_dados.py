...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:8nb11tWgzJvoMI3q@db.dsmuztbblfdhkartleen.supabase.co:5432/postgres'
...
def inicializar_banco():
    with app.app_context():
        ...
        autor = Autor(nome = 'cleber', email = 'Kelebyzinho@hotmail.com', senha = '654123', admin = True)
